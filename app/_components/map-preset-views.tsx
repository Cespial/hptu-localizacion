...
export const PRESET_VIEWS: PresetView[] = [
  ...
  },
  {
    ...
    label: "Palmas Bajo",
    icon: MapPin,
    center: [-75.5622, 6.2111],
    zoom: 14.5,
    enableLayers: ["palmasBajoHeatmap", "palmasBajoZone", "traffic", "healthFull", "pois", "corridor", "pot", "hptu"],
    disableLayers: ["strata", "routes", "catastro", "isochrones", "osmEducation", "osmCommercial", "orienteHealth", "accessPointIso", "accessPointRoutes", "medicalProjects", "orienteMunicipios"],
    description: "Zona candidata #1: heatmap de densidad, tráfico, competencia",
  },
  {
    id: "comparativa",
    label: "Comparativa",
