...
Hoy, el Hospital Pablo Tobón Uribe opera en Robledo con \textbf{540 camas}.
...
\begin{tikzpicture}
  ...
  \node[font=\LARGE\bfseries, coral] at (1.8, 0.6) {540};
  \node[font=\footnotesize, below] at (1.8, 0.15) {Camas HPTU};
\end{tikzpicture}
\end{center}
...
{\large\textcolor{white!90}{Un hospital con 540 camas en Robledo.}}
