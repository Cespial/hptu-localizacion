...
\begin{tikzpicture}
  ...
  \node[font=\Huge\bfseries, coral] at (2.5, 0.8) {540};
  \node[font=\small, below] at (2.5, 0.3) {Camas HPTU};
  \node[font=\tiny\color{slate}] at (2.5, -0.2) {Capacidad actual del hospital};
\end{tikzpicture}
\end{center}

\vspace{8pt}
El HPTU opera en \textbf{Robledo} con 540 camas. Mientras tanto:
...
Cl.\ Medellín & 184 & 88\% & 3.2 km \\
\rowcolor{coral!6}
HGM ESE & 384 & \danger{92\%} & 7+ km \\
Cl.\ del Prado & 152 & 85\% & 5+ km \\
...
\footnotesize
\begin{tabular}{@{}l@{}}
Red hospitalaria con \danger{1,593 camas} \\
...
\node[pillar] (p1) at (0,0) {
  ...
  Camas\\HPTU\\{\scriptsize capacidad actual}
};
